...
var json_fb='https://taghash.co/mloyalApps/facebookspecsmakers.php';
var RSS_twitter='https://taghash.co/mloyalApps/twitter.php?uname=specsmakersopt';
var RSS_pinterest='http://103.25.128.61/projects/taghash/mloyalApps/pinteresttantra.php?brand=specsmakers';
var RSS_instagram='https://www.instagram.com/specsmakers/?__a=1';
var RSS_youtube='http://xceedfbapps.com/mloyalfeeds/youtube.php?brandname=specsmakers';
var RSS_tumblr='http://xceedfbapps.com/mloyalfeeds/tumblr.php?brandurl=http://specsmakers.tumblr.com';

var brandname='specsmakers';
var aboutus_det='specsmakers';
var brand_url='https://www.specsmakers.in/';
var cart = { cartdata: []};
...
var SERVER = "https://specsmakers.mloyalretail.com/m/";
var SERVER1 = "https://specsmakers.mloyalretail.com/";
...
$(document).ready(function(event){
			   ...
			   if($.mobile.activePage.is('#homepage')){
                 ...
                 //getContacts();
                  if(localStorage.getItem("usernamespecsmakers")!=null && localStorage.getItem("usernamespecsmakers")!='' && localStorage.getItem("passwordspecsmakers")!=null && localStorage.getItem("passwordspecsmakers")!='')
                    {
                            $('#username').val(localStorage.getItem("usernamespecsmakers"));
                            $('#password_myacc').val(localStorage.getItem("passwordspecsmakers"));
							user.mobile = localStorage.getItem('usernamespecsmakers');
							var pwd = localStorage.getItem('passwordspecsmakers');
                        ...
                        if(user.mobile=='undefined' || user.mobile=='null' || user.mobile==null)
                           ...
                           // alert(user.firstname);
                            ...
                            document.getElementById("profilepts1").innerHTML=user.total+' points';
                             ...
                             $("#wait").css("display","none");
                             authenticate();
                          if(imageExists('https://taghash.co/mloyalfileupload/uploads/specsmakers_'+localStorage.getItem("usernamespecsmakers")+'.jpg'))
                          {
                              document.getElementById("cardImagemenu").src='https://taghash.co/mloyalfileupload/uploads/specsmakers_'+localStorage.getItem("usernamespecsmakers")+'.jpg';
                          }                     
                     }
				   else if(localStorage.getItem("usernamespecsmakers")!=null && localStorage.getItem("usernamespecsmakers")!='' && (localStorage.getItem("passwordspecsmakers")==null || localStorage.getItem("passwordspecsmakers")=='')) 
	                 {
			...
			success: function(data, textStatus, xhr) {
			 ...
			 if(data.toLowerCase()=='success'){
				 ...
				 $('#login-msg').html('The  passcode has been sent to your mobile.Please check your SMS.');
			      ...
			      $('#username').val(mob);
				  localStorage.setItem('usernamespecsmakers',mob);
...
function authenticate(){
 ...
 if(uname=='' || pwd==''){
  ...
  $.ajax({
   ...
   localStorage.setItem('usernamespecsmakers',uname);
   localStorage.setItem('passwordspecsmakers',pwd);
 ...
 if(user.mobile=='undefined' || user.mobile=='null' || user.mobile==null)
    ...
    {
	    if(localStorage.getItem("profiledone_specsmakers")){
    ...
    error: function(xhr, textStatus, errorThrown) {
	user.mobile = localStorage.getItem('usernamespecsmakers');
	pwd = localStorage.getItem('passwordspecsmakers');
	uname = user.mobile;
    user.balance = localStorage.getItem('balance');
    user.firstname = localStorage.getItem('firstname');
    user.lastname = localStorage.getItem('lastname');
...
$(document).on('pageinit', '#profilepage', function (event, ui) {
	...
	$.ajax({
			...
			success: function(data, textStatus, xhr) {
				...
				localStorage.setItem("profiledone_specsmakers","Yes");
...
function showRewards(){
	...
	openInWebView('https://specsmakers.mloyalretail.com/microsite/');
	//RewardsNA();
	/*
	if(user.mobile==null || user.mobile=='')
	{
...
if(id=='rewardstore' || id=='reward-cat' || id=='reward-brand')
	{
	tabserver = "https://specsmakers.mloyalretail.com/Rewards/";
	}
else
	{
	
	tabserver = "https://specsmakers.mloyalretail.com/m/";
	}
	$.getJSON(
		tabserver+url, {
		//page: url,
...
function renderTemplate(pageID, json) {
	...
	case 'inbox':
        ...
        str += '<span class="msghdr">DM-SPKMKR</span><span class="msgTime">'+json[i].msgtime+'</span>';
...
var str = '';
	...
	switch (pageID) {
		...
		case 'aboutus':
			...
			document.getElementById("barimg").innerHTML = '<img src="https://quickchart.io/qr?text='+mobileqr+'&size=80&margin=2" style="padding:10px;"/>';

			/*if(parseInt(user.balance)>=0 && parseInt(user.balance)<=10000)
            {
            ...
            else if(parseInt(user.balance)>=10001 && parseInt(user.balance)<=20000)
            {
               document.getElementById('silverslab').className = '';
               document.getElementById('goldslab').className = '';
		       document.getElementById('platinumslab').className = '';
            ...
            else if(parseInt(user.balance)>=20001)
            {
               document.getElementById('silverslab').className = '';
               document.getElementById('goldslab').className = '';
		       document.getElementById('platinumslab').className = '';
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json);
          ...
          localStorage.setItem('facebook_specsmakers',JSON.stringify(json.item));
		 ...
		 try{
			 renderTemplate(id,JSON.parse(localStorage.getItem('facebook_specsmakers')));
		 }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json.feed.entry);
          ...
          localStorage.setItem('youtube_specsmakers',JSON.stringify(json.feed.entry));
		   ...
		   try{
			 renderTemplate(id,JSON.parse(localStorage.getItem('youtube_specsmakers')));
		   }
		   catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
...
else if(url==RSS_twitter)
{
  ...
  $.ajax({
            ...
            localStorage.setItem('twitter_specsmakers', JSON.stringify(data));
                },
                error: function (xhr, textStatus, errorThrown) {
				...
				{
					renderTemplate(id, JSON.parse(localStorage.getItem('twitter_specsmakers')));
					//alert('here in catch');
				}
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json.body);
          ...
          localStorage.setItem('pinterest_specsmakers',JSON.stringify(json.body));
		   ...
		   try{
			    renderTemplate(id,JSON.parse(localStorage.getItem('pinterest_specsmakers')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
else if(url==RSS_tumblr)
{
  ...
  $.getJSON(
     url, {
        ...
        //  localStorage.setItem('twitter',JSON.stringify(json.responseData.feed.entries));
       localStorage.setItem('tumblr_specsmakers',JSON.stringify(json.channel.item));

    

       }).error(function () {
		   try{
			   renderTemplate(id,JSON.parse(localStorage.getItem('tumblr_specsmakers')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
else if(url==RSS_instagram)
{
  ...
  $.getJSON(
     url, {
        ...
        //  localStorage.setItem('twitter',JSON.stringify(json.responseData.feed.entries));
       localStorage.setItem('instagram_specsmakers',JSON.stringify(json.user));

    

       }).error(function () {
		   try{
			   renderTemplate(id,JSON.parse(localStorage.getItem('instagram_specsmakers')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
function receivedEvent(id) {
 ...
 var push = PushNotification.init({ "android": {"senderID": "626545070201"}});
...
function addincart(i)
{
	...
	cart.cartdata.push({ 
   "index":i,
   "url" : "https://specsmakers.mloyalretail.com/"+jsonary[i].brand_logo,
...
function checkout(){
  ...
  $.ajax({
    url: 'https://specsmakers.mloyalretail.com/Rewards/complete.asp',
    type: 'GET',
    timeout: 50000,
...
function giftfriend(){
  ...
  var val=$('#giftpt').val();
  $.ajax({
    url: 'https://specsmakers.mloyalretail.com/m/gift_points_api.asp',
    type: 'GET',
    timeout: 50000,
    dataType: 'text', //xml/html/script/json/jsonp
...
function shareApp()
{
	window.plugins.socialsharing.share('Hi, Join Specsmakers Loyalty Program.', null, 'https://taghash.co/shareimg/specsmakers.jpg', 'https://specsmakers.mloyalretail.com/mapp');
}
...
function rateApp()
{
	var deviceType = (navigator.userAgent.match(/iPad/i))  == "iPad" ? "iPad" : (navigator.userAgent.match(/iPhone/i))  == "iPhone" ? "iPhone" : (navigator.userAgent.match(/Android/i)) == "Android" ? "Android" : (navigator.userAgent.match(/BlackBerry/i)) == "BlackBerry" ? "BlackBerry" : "null";
		 if (deviceType=='iPad' || deviceType=='iPhone') 
			 ...
			 {
               window.open("market://details?id=com.mobiquest.specsmakers","_system");
...
function showShop(){
    ...
    openInWebView('https://www.specsmakers.in/');
   
}
function showShop11(){

    //openInWebView('https://www.specsmakers.in/');
	var ref = window.open('https://www.specsmakers.in/', '_blank');
   
}

function openInWebView2(url)
{
...
$("input[type=file]").change(function(){
  ...
  // alert($("input[type=file]")[0].files[0]);
    ...
    aFormData.append("brand", "specsmakers");
	...
	$.ajax(
    {
      ...
      success     : 
        function(data)
        {
         ...
         document.getElementById("cardImagemenu").src='https://taghash.co/mloyalfileupload/uploads/specsmakers_'+localStorage.getItem("username")+'.jpg';
      //   document.getElementById("cardImage").src='http://103.25.128.61:9296/mloyalfileupload/uploads/specsmakers_'+localStorage.getItem("username")+'.jpg';
        }
    });
...
function logoutApp()
{
	localStorage.setItem("usernamespecsmakers",'');
	localStorage.setItem("passwordspecsmakers",'');
	localStorage.setItem("profiledone_specsmakers",'');
...
function uploadPhoto(imageURI) {
				...
				var fName='specsmakers_'+user.mobile;
...
function refer()
{
  ...
  if(referred_mobile1=='' || referred_name1=='' )
    ...
    $.ajax({
     url: 'https://specsmakers.mloyalretail.com/APIS/referral_api.asp',
     type: 'GET',
     timeout: 50000,
     dataType: 'html',
     data: {
