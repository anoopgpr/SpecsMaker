    ...
    Plugin.prototype = {
        ...
        **********************************************************/
        init: function () {
			...
			console.log("current"+base.data.currentSlide);
        ...
        **********************************************************/
        _onMoveEnd: function () {
            ...
            console.log(base.data.currentSlide);

			 if(base.data.currentSlide==2)
			{
				...
				if(localStorage.getItem("usernamespecsmakers")!=null && localStorage.getItem("usernamespecsmakers")!='' && localStorage.getItem("passwordspecsmakers")==null && localStorage.getItem("passwordspecsmakers")=='')
				{
				 ...
				 if(localStorage.getItem("usernamespecsmakers")==null || localStorage.getItem("usernamespecsmakers")=='' )
                                   {
